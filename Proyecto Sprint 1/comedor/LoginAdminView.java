...
public class LoginAdminView extends JFrame {
    ...
    public LoginAdminView() {
        ...
        JLabel title = new JLabel("ACCESO ADMINISTRATIVO");
        title.setForeground(new Color(150, 0, 0));
        title.setFont(new Font("Segoe UI", Font.BOLD, 26));
        title.setHorizontalAlignment(SwingConstants.CENTER);

        JLabel camnombre = new JLabel("Usuario Admin");
        ...
        // --- BOTONES CORREGIDOS ---
        btnEntrada = crearBotonEstilizado("INICIAR SESIÓN", new Color(180, 0, 0)); // Rojo
        btnRegistro = crearBotonEstilizado("Registrar nuevo Admin", new Color(80, 80, 80)); // Gris
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new LoginAdminController());
    }
}