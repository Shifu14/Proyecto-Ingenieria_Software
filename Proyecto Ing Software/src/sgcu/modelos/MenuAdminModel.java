...
public class MenuAdminModel {
    ...
    //METODOS DE LOGICA PARA EL CONTROLADOR

    public List<MenuAdminModel> obtenerTodos() {
        return cargarTodos();
    }

    public boolean guardarPlato(String id, String nombre, String desc, String precio, String dia, String servicio) {
        try {
    ...
    public boolean actualizarPlato(String id, String nombre, String desc, String precio, String dia, String servicio) {
        List<MenuAdminModel> lista = cargarTodos();
