...
public class DashboardAdminView extends JFrame {
    ...
    private JButton btnMenu, btnCostos, btnGestionEstudiantil, btnReservas, btnLogout;
    ...
    private void inicializarComponentes() {
        ...
        btnGestionEstudiantil = crearBotonSidebar("Gestión Estudiantil");
        btnReservas = crearBotonSidebar("Ver Reservas");
        ...
        sidebar.add(Box.createRigidArea(new Dimension(0, 15))); 
        sidebar.add(btnGestionEstudiantil);
        sidebar.add(Box.createRigidArea(new Dimension(0, 15)));
        ...
        lblBienvenida = new JLabel("Hola, Admin");
    ...
    public void addGestionEstudiantilListener(ActionListener l) { btnGestionEstudiantil.addActionListener(l); }
