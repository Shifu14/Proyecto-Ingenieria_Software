...
public class CargaCostosView extends JFrame {
    ...
    public CargaCostosView() {
        ...
        // SECCIÓN DERECHA (BÚSQUEDA + TABLA)
        JPanel panelTablaYBusqueda = new JPanel(new BorderLayout());
        panelTablaYBusqueda.setOpaque(false);

        // BARRA DE BÚSQUEDA
        JPanel toolbar = new JPanel(new FlowLayout(FlowLayout.LEFT));
        toolbar.setBackground(new Color(230, 230, 230));
        txtBuscar = new JTextField(15);
        btnFiltrar = crearBotonEstilizado("Buscar", new Color(100, 100, 100));
        btnFiltrar.setPreferredSize(new Dimension(90, 30));

        toolbar.add(new JLabel("Buscar periodo: "));
        toolbar.add(txtBuscar);
        toolbar.add(btnFiltrar);

        panelTablaYBusqueda.add(toolbar, BorderLayout.NORTH);
        ...
        panelTablaYBusqueda.add(scrollTabla, BorderLayout.CENTER);
        ...
        // Agrega el panel combinado en lugar de solo la tabla
        mainContent.add(panelTablaYBusqueda, gbc);
    ...
    public String getTextoBusqueda() { return txtBuscar.getText(); } // Nuevo getter
    ...
    public void addFiltrarListener(ActionListener l) { btnFiltrar.addActionListener(l); } // Nuevo listener
